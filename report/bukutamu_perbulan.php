...
<html>
    <head>
        <title>Cetak Data Tamu Perbulan</title>
    ...
    <body onload="print()">
        ...
        <div class="container">
            <div class='row'>
                ...
                <thead>
								<tr>
									<th>No.</th><th>Tanggal</th><th>Nama Tamu</th><th>Alamat</th><th width="10%">Instansi</th><th><center>Tujuan</center></th><th><center>Perihal</center></th>
								</tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM tb_tamu WHERE substr(tanggal,1,7)='$ambilthn-$ambilbln'";
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
									<td><?= $data['id'] ?></td>
                                    <td><?= $data['tanggal'] ?></td>
                                    <td><?= $data['nama'] ?> - <?= $data['no_laci'] ?> - <?= $data['no_boks'] ?></td>
                                    <td><?= $data['alamat'] ?></td>
									<td><?= $data['instansi'] ?></td>
									<td><?= $data['tujuan'] ?></td>
									<td><?= $data['perihal'] ?></td>
