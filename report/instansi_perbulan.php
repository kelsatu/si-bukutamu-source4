...
<html>
    <head>
        <title>Cetak Data Instansi Tamu Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA INSTANSI TAMU PERBULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_instansi WHERE substr(tanggal,1,7)='$ambilthn-$ambilbln'";
