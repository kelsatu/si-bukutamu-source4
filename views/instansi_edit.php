        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Update Data Instansi</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Update Data Instansi</button>
                            </div>
                        </div>
                    </form>
...
if($_POST){
    ...
    $alamat=$_POST['alamat'];
    //buat sql
    $sql="UPDATE tb_instansi SET tanggal='$tanggal',nama='$nama',alamat='$alamat' WHERE no ='$no'"; 
